...
# https://discuss.ray.io/t/connecting-to-remote-ray-cluster-on-k8s/7460
def main():
    ray.init(
    ...
    # Keep the script running to maintain the actors
    try:
        import time
        ...
        print(f"worker processes have stopped")
