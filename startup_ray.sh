...
(sleep 5 && RAY_DEDUP_LOGS=0 python run_ray_network_worker.py --name network:main --num-workers 10 --num-cpus 0.1 --num-gpus 0) &
(sleep 5 && RAY_DEDUP_LOGS=0 python run_ray_gpu_worker.py --name gpu --num-workers 3 --num-cpus 0.5 --num-gpus 0.2) &
(sleep 5 && RAY_DEDUP_LOGS=0 python run_ray_cpu_worker.py --name cpu:main --num-workers 10 --num-cpus 0.5 --num-gpus 0) &
